...
METRICS = {
    ...
    "aluminum": {
        "name": "Aluminum",
        "name_zh": "铝",
        "description": "Aluminum futures. The most China-sensitive industrial metal (~60% of global production). Proxy for Chinese industrial activity and global construction/infrastructure demand.",
        "source_type": "yfinance",
        "ticker": "ALI=F",
        "unit": "$/t",
    },
    ...
    "remx": {
        ...
        "name_zh": "稀土ETF",
        "description": "VanEck Rare Earth/Strategic Metals ETF. Proxy for rare earth supply chain. China controls ~70% of processing. Critical for EV motors, wind turbines, defense, and AI hardware.",
        "source_type": "yfinance",
        "ticker": "REMX",
        "unit": "$",
    },
    ...
    "brent": {
        "name": "Brent Crude",
        "name_zh": "布伦特原油",
        "description": "Brent crude futures — the global oil benchmark. OPEC+ prices off Brent, not WTI. More geopolitically relevant: Middle East tensions, Russia sanctions, and tanker route disruptions show up here first.",
        "source_type": "yfinance",
        "ticker": "BZ=F",
        "unit": "$/bbl",
    },
    ...
    "djia": {
        "name": "Dow Jones",
        "name_zh": "道琼斯工业指数",
        "description": "Dow Jones Industrial Average — 30 blue-chip, old-economy-heavy stocks. When Dow outperforms QQQ, market is rotating from tech into industrials/real economy.",
        "source_type": "yfinance",
        "ticker": "^DJI",
        "unit": "index",
    },
    ...
    "iwm": {
        ...
        "name_zh": "罗素2000小盘股",
        "description": "iShares Russell 2000 ETF — US small-cap proxy. Most rate-sensitive part of the market. Small-cap strength = domestic economic confidence; weakness = credit stress hitting Main Street.",
        "source_type": "yfinance",
        "ticker": "IWM",
        "unit": "$",
    },
